...
{
    options.SwaggerDoc("v1", new OpenApiInfo { Title = "Csharp.Net.Jwt.EcdsaKey.Client", Version = "v1" });
...
config["EcdsaKey"] = File.ReadAllText(builder.Configuration["EcdsaKeyPath"]);
